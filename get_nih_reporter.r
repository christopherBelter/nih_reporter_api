...
create_query <- function(FY = "", IC = "", is_admin_ic = "", is_funding_ic = "", include_active = "", pi_name = "", org_names = "", exclude_subprojects = "", activity_code = "", funding_mechanism = "", foa = "", covid_response = "") {
	theQ <- list(
		criteria = list(
		   fiscal_years = FY, 
		   agencies = IC, 
